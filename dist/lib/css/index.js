...
var text_fill_color_1 = require("./property-descriptors/text-fill-color");
...
var text_stroke_color_1 = require("./property-descriptors/text-stroke-color");
var text_stroke_width_1 = require("./property-descriptors/text-stroke-width");
...
var filter_1 = require("./property-descriptors/filter");
var CSSParsedDeclaration = /** @class */ (function () {
    function CSSParsedDeclaration(declaration) {
        ...
        this.filter = parse(filter_1.filter, declaration.filter);
        ...
        this.textFillColor = parse(text_fill_color_1.textFillColor, declaration.textFillColor);
        ...
        this.textStrokeColor = parse(text_stroke_color_1.textStrokeColor, declaration.webkitTextStrokeColor);
        this.textStrokeWidth = parse(text_stroke_width_1.textStrokeWidth, declaration.webkitTextStrokeWidth);
