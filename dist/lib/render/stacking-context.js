...
var ElementPaint = /** @class */ (function () {
    function ElementPaint(element, parentStack) {
        ...
        if (element.styles.opacity < 1) {
            this.effects.push(new effects_1.OpacityEffect(element.styles.opacity, 4 /* CONTENT */));
        }
    }
    ElementPaint.prototype.getParentEffects = function () {
        ...
        if (this.container.styles.opacity < 1) {
            effects.push(new effects_1.OpacityEffect(this.container.styles.opacity, 4 /* CONTENT */));
        }
        return effects;
    };
    return ElementPaint;
